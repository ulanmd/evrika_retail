...
class QrScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: appBarWithBackBtn(context, 'Поиск по QR'),
        ...
        return Stack(
          children: [
                ...
                !searchQrX.allow ?  MobileScanner(
                    ...
                    onDetect: (barcode, args) async {
                      if (barcode.rawValue == null) {
                        ...
                        var itemFromQr = await HttpClient.getCategoryByQr(code);
            ...
            Positioned(
              ...
              left: 0,
              right: 0,
              child: (searchQrX.itemWasFound && !loading.isLoading) && !searchQrX.incorrectCode
                  ? Padding(
              ...
              Container(
                  ...
                  ), child: Text('Некорректный QR код! Попробуйте заново', style: EvrikaTextStyles.whiteS15W500,),) : Container()
                ,),
            )
          ],
        );
